...
return [
    ...
    */
    ...
    'disks' => [
        ...
        // 'gcs' => [
        //     'driver' => 'gcs',
        //     // 'key_file_path' => env('GOOGLE_CLOUD_KEY_FILE', base_path('cloud-storage.json')), // optional: /path/to/service-account.json
        //     'key_file' => [
        ...
        //     'storage_api_uri' => env('GOOGLE_CLOUD_STORAGE_URL', null), // see: Public URLs below
        ...
        'gcs' => [
            'driver' => 'gcs',
            'key_file' => [], // Use default service account
